	...
	testCases := []OpcodeTestCase{
		{
			...
			// 	[]byte{0x7F}, // PUSH32
			// 	append(
			// 		hexutil.MustDecode("0xFF01000000000000000000000000000000000000000000000000000000000001")[:],
			// 		0x60, 0x00, // PUSH1 0
			// 		0x52, // MSTORE
			// 		0x00, // Stop
			// 	)...,
			...
			expectedMemory: &Memory{
				...
				// store: common.Hex2Bytes("FF01000000000000000000000000000000000000000000000000000000000001"),
			},
